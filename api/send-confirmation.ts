...
function formatDate(iso: string) {
  ...
  return {
    ...
    badge: d.toLocaleDateString('en-NG', { month: 'long', day: 'numeric', year: 'numeric', ...opts }).toUpperCase(),
    time: d.toLocaleTimeString('en-NG', { hour: '2-digit', minute: '2-digit', ...opts }),
  };
}
...
<div style="background-color:#2b2b22;border-radius:4px;overflow:hidden;">
  ...
  <div style="padding:40px 40px 36px;">
    <div style="display:inline-block;background-color:#3a3a2e;color:#9e9880;font-size:11px;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;padding:6px 12px;border-radius:2px;margin-bottom:24px;">CRACKS &amp; HEALING &middot; ${opts.badgeDate}</div>
    ...
    <p style="font-size:15px;color:#9e9880;line-height:1.6;margin-top:14px;">Hi ${opts.name}, a kintsugi repair workshop awaits you on ${opts.shortDate}. We can't wait to see you.</p>
  </div>
  ...
  <div style="background-color:#242420;margin:0 40px 8px;border-radius:4px;padding:28px 28px 20px;">
    ...
    <hr style="border:none;border-top:1px solid #38362d;margin-bottom:20px;"/>
    <p style="font-size:14px;color:#9e9880;line-height:1.7;margin-bottom:24px;">To confirm your spot, transfer the deposit to the account below and send proof of payment to <a href="mailto:kellyraise@gmail.com" style="color:#c9a96e;text-decoration:none;">kellyraise@gmail.com</a>.</p>
